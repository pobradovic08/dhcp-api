...
class ReservationEntryTest extends PHPUnit_Framework_TestCase {
    ...
    public function fullData () {
        $subnet = new SubnetEntry(array ('subnet_id' => 1, 'network' => '10.0.0.0', 'network_mask' => '255.255.255.0',
                                      'vlan' => 4, 'subnet_description' => 'Test subnet'));
        $group = new GroupEntry(array ('group_id' => 10, 'group_subnet_id' => 1, 'group_name' => 'test_name',
                                    'group_description' => 'Test group description'));
        $end_host_type = new EndHostTypeEntry(array ('end_host_type_id' => 1000,
                                                  'end_host_type_description' => 'Test end host'));
        $end_host = new EndHostEntry(array ('end_host_id' => 100, 'hostname' => 'test.example.com', 'mac' => '1234.5678.9abc',
